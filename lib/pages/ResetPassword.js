...
function ResetPassword(props) {
    ...
    return _jsx(SimpleLayout, Object.assign({ branding: props.branding }, { children: _jsx("div", Object.assign({ className: "h-100 w-100 d-flex" }, { children: _jsx(Card, Object.assign({ className: "mx-auto my-auto col-md-6" }, { children: _jsxs(Card.Body, { children: [_jsx(Card.Title, { children: "Reset Password" }, void 0), successful
                            ? _jsx(Card.Text, Object.assign({ className: "text-success" }, { children: "Password changed successfully" }), void 0)
