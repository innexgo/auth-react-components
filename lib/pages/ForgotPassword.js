...
function ForgotPasswordForm(props) {
    ...
    return (_jsx(Formik, Object.assign({ onSubmit: onSubmit, initialValues: {
            email: "",
        }, initialStatus: "" }, { children: (props) => (_jsxs(Form, Object.assign({ noValidate: true, onSubmit: props.handleSubmit }, { children: [_jsxs(Form.Group, Object.assign({ className: "mb-3" }, { children: [_jsx(Form.Label, { children: "Email" }), _jsx(Form.Control, { name: "email", type: "email", placeholder: "Email", value: props.values.email, onChange: props.handleChange, isInvalid: !!props.errors.email }), _jsxs(Form.Control.Feedback, Object.assign({ type: "invalid" }, { children: [" ", props.errors.email, " "] }))] })), _jsx(Form.Group, Object.assign({ className: "mb-3" }, { children: _jsx(Button, Object.assign({ type: "submit" }, { children: "Submit" })) })), _jsx(Form.Group, Object.assign({ className: "mb-3" }, { children: _jsx(Form.Text, Object.assign({ className: "text-danger" }, { children: props.status })) }))] }))) })));
}
function ForgotPassword(props) {
    const [successful, setSuccess] = React.useState(false);
    return _jsx(DefaultSidebarLayout, Object.assign({ branding: props.branding }, { children: _jsx("div", Object.assign({ className: "h-100 w-100 d-flex" }, { children: _jsx(Card, Object.assign({ className: "mx-auto my-auto col-md-6" }, { children: _jsxs(Card.Body, { children: [_jsx(Card.Title, { children: "Send Reset Password Email" }), successful
                            ? _jsx(Form.Text, Object.assign({ className: "text-success" }, { children: "We've sent an email to reset your password." }))
                            : _jsx(ForgotPasswordForm, { onSuccess: () => setSuccess(true) })] }) })) })) }));
}
