...
function CreateEmail(props) {
    ...
    return _jsx(_Fragment, { children: _jsx(Formik, Object.assign({ onSubmit: onSubmit, initialValues: {
                ...
                failureResult: "",
                successResult: ""
            } }, { children: (fprops) => _jsx(_Fragment, { children: _jsxs(Form, Object.assign({ noValidate: true, onSubmit: fprops.handleSubmit }, { children: [_jsxs("div", Object.assign({ hidden: fprops.status.successResult !== "" }, { children: [_jsx(Button, Object.assign({ type: "submit" }, { children: "Complete Registration" })), _jsx("br", {}), _jsx(Form.Text, Object.assign({ className: "text-danger" }, { children: fprops.status.failureResult }))] })), _jsx(Form.Text, Object.assign({ className: "text-success" }, { children: fprops.status.successResult }))] })) }) })) });
}
function EmailConfirm(props) {
    var _a;
    const [email, setEmail] = React.useState(null);
    return (_jsx(DefaultSidebarLayout, Object.assign({ branding: props.branding }, { children: _jsx("div", Object.assign({ className: "h-100 w-100 d-flex" }, { children: _jsx(Card, Object.assign({ className: "mx-auto my-auto col-md-6" }, { children: _jsxs(Card.Body, { children: [_jsx(Card.Title, { children: "Confirm Email" }), email !== null
                            ? _jsxs(Card.Text, { children: ["Your email (", email.verificationChallenge.email, "), has been confirmed. Click ", _jsx("a", Object.assign({ href: props.branding.dashboardUrl }, { children: "here" })), " to login."] })
                            : _jsx(CreateEmail, { verificationChallengeKey: ((_a = new URLSearchParams(window.location.search).get("verificationChallengeKey")) !== null && _a !== void 0 ? _a : "")
                                    .replace(' ', '+'), postSubmit: e => {
                                    var _a;
                                    // if email is upgraded, then you need to re-log-in
                                    if (((_a = props.apiKey) === null || _a === void 0 ? void 0 : _a.apiKeyKind) === "NO_EMAIL") {
